...
from sunyata.pytorch.arch.convmixer import  BayesSEConvMixer2, ConvMixer3, ConvMixerCfg, ConvMixer, BayesConvMixer
from sunyata.pytorch.arch.iterative import ConvMixerattn, ConvMixerattn2
# %%
