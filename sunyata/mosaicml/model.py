...
from sunyata.pytorch.arch.convmixer import BayesConvMixerattn, BayesConvMixereca, BayesConvMixerecaAttn, ConvMixerCfg, ConvMixer, BayesConvMixer, ConvMixereca
# %%
