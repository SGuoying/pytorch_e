...
from sunyata.pytorch.arch.conv_former import ConvMixerV1, ConvMixerV2, ConvMixerV3, ConvMixerV3_1, ConvMixerV4, ConvMixerV5
...
def build_composer_convmixer(model_name: str = 'convmixer',
    ...
    elif model_name == "ConvMixerV5":
        model = ConvMixerV5(cfg)
