...
from sunyata.pytorch.arch.convmixer import  BayesConvMixerattn, BayesConvMixereca, BayesConvMixerecaAttn, CombineConvMixer, ConvMixerCfg, ConvMixer, BayesConvMixer, ConvMixereca
# %%
